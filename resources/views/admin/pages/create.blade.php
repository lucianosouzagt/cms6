...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3>Cadastro de Página</h3>
        </div>
        <div class="card-body">
            <form action="{{route('pages.store')}}" method="POST"class="mt-3 form-horizontal">
                @csrf
                <div class="form-group row">
                    <label for="title" class="ml-5 col-sm-2 col-form-label">Título</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" value="{{old('title')}}" placeholder="Digite o título da página">
                    </div>
                </div>
                <div class="form-group row">       
