...
@section('content_header')
    ...
    <div class="row">
        <div class="col-sm-6">
            <h1>Site - Cadastro Informações Gerais</h1>
        </div>
        <div class="col-sm-3">
            <form method="get">
        ...
        <div class="card-body">
            ...
            <form action="{{route('settings.store')}}" method="POST"class="form-horizontal">
                ...
                <div class="form-group row">
                    <label for="langs" class="ml-5 col-sm-2 col-form-label">Selecione o idioma</label>
                    <div class="col-sm-8">
                        <select style="width:160px; height:35px" onChange="this.form.submit()" name="langs" id="langs" class="form-control float-md-right">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="clientTitle" id="clientTitle" value="" placeholder="Exemplo: Titulo do Site">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="more" class="ml-5 col-sm-2 col-form-label">Saiba mais</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="more" id="more" value="" placeholder="Exemplo: Saiba mais">
                    </div>
                </div>
                <div class="form-group row">       
                    <label for="about" class="ml-5 col-sm-2 col-form-label">Sobre reduzido</label>
                    <div class="col-sm-8">
                        <textarea name="about" class="form-control titlefield" id="about" rows="4"></textarea>
                    </div>
                </div> 
                <div class="form-group row">       
                    <label for="aboutContent" class="ml-5 col-sm-2 col-form-label">Sobre completo</label>
                    <div class="col-sm-8">
                        <textarea name="aboutContent" class="form-control bodyfield" id="aboutContent" rows="8"></textarea>
                    </div>
                </div> 
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="maps" id="maps" value="">
                    </div>
                </div>
                <div class="form-group row">
